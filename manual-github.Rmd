...
data_visibilityTable <- data.frame(
  ...
  Owner = c("Yes", "Yes", "Yes", "Yes", "Yes"),
  Member = c("Yes", "Yes", "Yes", "Yes", "No"),
  Outside_collaborator = c("Yes", "Yes", "No", "Yes", "No")
)
...
data_managementTable <- data.frame(
  ...
  Owner = c("Yes", "Yes", "Yes", "Yes", "Yes", "Yes"),
  Member = c("No", "No", "No", "No", "No", "No"),
  Outside_collaborator = c("No", "No", "No", "No", "No", "No")
)
...
data_baserepositoryrightsTable <- data.frame(
  ...
  Outside_collaborator = c("No", "No", "No", "No", "No")
)
...
data_repositoryAccessTable <- data.frame(
  ...
  Read = c("Yes", "Yes", "Yes", "Yes", "Yes", "No", "No", "No", "No", "No", "No", "No"),
  Triage = c("Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "No", "No", "No", "No", "No", "No"),
  Write = c("Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "No", "No", "No"),
  Maintain = c("Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "No", "No", "No"),
  Admin = c("Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes")
)
